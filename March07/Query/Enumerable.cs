...
namespace BdsSoft
{
    namespace Linq
    {
        ...
        public static class Enumerable
        {
            ...
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            ...
            /// </summary>
            /// <typeparam name="T">Type of the elements in the outer source Enumerable.</typeparam>
            /// <typeparam name="U">Type of the elements in the inner source Enumerable.</typeparam>
            /// <typeparam name="K">Type of the key field to perform the join on.</typeparam>
            /// <typeparam name="V">Type of the elements in the result Enumerable.</typeparam>
            ...
            /// <summary>
            /// Groups a sequence based on extracted key values using the default equality comparer for the key type <typeparamref name="K">K</typeparamref>. When the returned sequence is enumerated, it enumerates source and evaluates the <paramref name="keySelector">keySelector</paramref> function once for each source element. Once all key and destination element pairs have been collected, a sequence of <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="T">T</typeparamref>&gt; instances are yielded. Each <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="T">T</typeparamref>&gt; instance represents a sequence of destination elements with a particular key value. The groupings are yielded in the order that their key values first occurred in the source sequence, and destination elements within a grouping are yielded in the order their source elements occurred in the source Enumerable. When creating the groupings, key values are compared using the default equality comparer, EqualityComparer&lt;<typeparamref name="K">K</typeparamref>&gt;.Default.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            ...
            /// <summary>
            /// Groups a sequence based on extracted key values using the specified equality comparer for the key type <typeparamref name="K">K</typeparamref>. When the returned sequence is enumerated, it enumerates source and evaluates the <paramref name="keySelector">keySelector</paramref> function once for each source element. Once all key and destination element pairs have been collected, a sequence of <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="T">T</typeparamref>&gt; instances are yielded. Each <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="T">T</typeparamref>&gt; instance represents a sequence of destination elements with a particular key value. The groupings are yielded in the order that their key values first occurred in the source sequence, and destination elements within a grouping are yielded in the order their source elements occurred in the source Enumerable. When creating the groupings, key values are compared using the given <paramref name="comparer">comparer</paramref>, or, if a null <paramref name="comparer">comparer</paramref> was specified, using the default equality comparer, EqualityComparer&lt;<typeparamref name="K">K</typeparamref>&gt;.Default.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            /// <typeparam name="K">Type of the key on which the group operation is performed.</typeparam>
            /// <param name="source">Sequence to group elements from.</param>
            ...
            {
                return GroupBy<T, K, T>(source, keySelector, delegate(T t) { return t; } /* e => e */, comparer);
            }

            /// <summary>
            /// Groups a sequence based on extracted key values using the default equality comparer for the key type <typeparamref name="K">K</typeparamref>. When the returned sequence is enumerated, it enumerates source and evaluates the <paramref name="keySelector">keySelector</paramref> and <paramref name="elementSelector">elementSelector</paramref> functions once for each source element. Once all key and destination element pairs have been collected, a sequence of <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="E">E</typeparamref>&gt; instances are yielded. Each <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="E">E</typeparamref>&gt; instance represents a sequence of destination elements with a particular key value. The groupings are yielded in the order that their key values first occurred in the source sequence, and destination elements within a grouping are yielded in the order their source elements occurred in the source Enumerable. When creating the groupings, key values are compared using the default equality comparer, EqualityComparer&lt;<typeparamref name="K">K</typeparamref>&gt;.Default.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            /// <typeparam name="K">Type of the key on which the group operation is performed.</typeparam>
            ...
            /// <summary>
            /// Groups a sequence based on extracted key values using the specified equality comparer for the key type <typeparamref name="K">K</typeparamref>. When the returned sequence is enumerated, it enumerates source and evaluates the <paramref name="keySelector">keySelector</paramref> and <paramref name="elementSelector">elementSelector</paramref> functions once for each source element. Once all key and destination element pairs have been collected, a sequence of <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="E">E</typeparamref>&gt; instances are yielded. Each <see cref="IGrouping&lt;K, T&gt;">IGrouping</see>&lt;<typeparamref name="K">K</typeparamref>, <typeparamref name="E">E</typeparamref>&gt; instance represents a sequence of destination elements with a particular key value. The groupings are yielded in the order that their key values first occurred in the source sequence, and destination elements within a grouping are yielded in the order their source elements occurred in the source Enumerable. When creating the groupings, key values are compared using the given <paramref name="comparer">comparer</paramref>, or, if a null <paramref name="comparer">comparer</paramref> was specified, using the default equality comparer, EqualityComparer&lt;<typeparamref name="K">K</typeparamref>&gt;.Default.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            /// <typeparam name="K">Type of the key on which the group operation is performed.</typeparam>
            /// <typeparam name="E">Type of the result elements.</typeparam>
            ...
            /// <summary>
            /// Creates an array from a sequence by enumerating the source sequence and returning an array of type <typeparamref name="T">T</typeparamref>[] containing the elements of the Enumerable.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            ...
            /// <summary>
            /// Creates a list from a sequence by enumerating the source sequence and returning a list of type List&lt;<typeparamref name="T">T</typeparamref>&gt; containing the elements of the Enumerable.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            ...
            public static Dictionary<K, T> ToDictionary<T, K>(
                ...
                Func<T, K> keySelector)
            {
                return ToDictionary<T, K, T>(source, keySelector, delegate(T t) { return t; } /* t => t */, EqualityComparer<K>.Default);
            }
            ...
            public static Dictionary<K, T> ToDictionary<T, K>(
                ...
                IEqualityComparer<K> comparer)
            {
                return ToDictionary<T, K, T>(source, keySelector, delegate(T t) { return t; } /* t => t */, comparer);
            }
            ...
            public static Lookup<K, T> ToLookup<T, K>(
                ...
                Func<T, K> keySelector)
            {
                return ToLookup<T, K, T>(source, keySelector, delegate(T t) { return t; } /* t => t */, EqualityComparer<K>.Default);
            }
            ...
            public static Lookup<K, T> ToLookup<T, K>(
                ...
                IEqualityComparer<K> comparer)
            {
                return ToLookup<T, K, T>(source, keySelector, delegate(T t) { return t; } /* t => t */, comparer);
            }
            ...
            /// </summary>
            /// <typeparam name="T">Type of the elements in the result Enumerable.</typeparam>
            ...
            /// <summary>
            /// Returns the first element of a Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            /// <param name="source">Sequence to get the first element from.</param>
            /// <returns>The first element from the source Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned.</returns>
            ...
            /// <summary>
            /// Returns the last element of a Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            /// <param name="source">Sequence to get the last element from.</param>
            /// <returns>The last element from the source Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned.</returns>
            ...
            /// </summary>
            /// <typeparam name="T">Type of the element in the source Enumerable.</typeparam>
            ...
            /// <summary>
            /// Returns the single element of a Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned. An <c>InvalidOperationException</c> is thrown if the source sequence contains more than one element.
            /// </summary>
            /// <typeparam name="T">Type of the element in the source Enumerable.</typeparam>
            /// <param name="source">Sequence to get the single element from.</param>
            /// <returns>The single element from the source Enumerable. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is returned. An <c>InvalidOperationException</c> is thrown if the source sequence contains more than one element.</returns>
            ...
            /// <param name="source">Sequence to get the element on the specified position from.</param>
            /// <param name="index">Index of the element to retrieve from the Enumerable.</param>
            /// <remarks>Extension method for IEnumerable&lt;<typeparamref name="T">T</typeparamref>&gt;. Use <see cref="ElementAt">ElementAt</see> to throw an <c>ArgumentOutOfRangeException</c> in case the <paramref name="index">index</paramref> is less than zero or greater than or equal to the number of elements in the Enumerable.</remarks>
            ...
            /// <summary>
            /// Supplies a default element for an empty Enumerable. When the returned object is enumerated, it enumerates the source sequence and yields its elements. If the source sequence is empty, <c>default(<typeparamref name="T">T</typeparamref>)</c> is yielded in place of an empty Enumerable.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
            ...
            /// </summary>
            /// <typeparam name="T">Type of the <paramref name="element">element</paramref> to be repeated in the result Enumerable.</typeparam>
            ...
            /// <summary>
            /// Counts the number of elements in a Enumerable. If the source sequence implements ICollection&lt;<typeparamref name="T">T</typeparamref>&gt;, the sequence's implementation of ICollection&lt;<typeparamref name="T">T</typeparamref>&gt; is used to obtain the element count. Otherwise, the source sequence is enumerated to count the number of elements. An <c>OverflowException</c> is thrown is the count exceeds <c>int.MaxValue</c>.
            /// </summary>
            /// <typeparam name="T">Type of the elements in the source Enumerable.</typeparam>
        ...
        /// </summary>
        /// <typeparam name="T">Type of the elements in the ordered Enumerable.</typeparam>
        public class OrderedSequence<T> : System.Collections.Generic.IEnumerable<T>
        {
            /// <summary>
            /// Used when ordered sequence is at the leaf level. At the leaf level, an ordered sequence contains a list with the ordered groups of elements (each represented as a List&lt;<typeparamref name="T">T</typeparamref>&gt;).
            /// </summary>
            /// <example>
            ...
            /// <summary>
            /// Used when ordered sequence is not at the leaf level. Inside the tree, an ordered sequence contains a list of ordered sequences (each represented as a OrderedSequence&lt;<typeparamref name="T">T</typeparamref>&gt;) one level deeper in the tree.
            /// </summary>
            /// <example>
