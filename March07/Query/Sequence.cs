    ...
    namespace Query
    {
        ...
        public static class Sequence
        {
                ...
                IEnumerable<T> second)
            {
                ...
                if (Sequence.Count(first) != Sequence.Count(second))
                    return false;
            ...
            /// <param name="func">Function to calculate the aggregated value based on the current internal accumulator value and the current element from the source sequence. function is called repeatedly for each element of the source sequence in order to obtain the aggregation value.</param>
