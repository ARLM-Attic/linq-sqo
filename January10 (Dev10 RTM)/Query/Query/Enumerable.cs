    ...
    namespace Linq
    {
        ...
        public static class Enumerable
        {
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return _Where(source, (item, i) => predicate(item));
            }
                ...
                Func<TSource, TResult> selector)
            {
                ...
                return _Select(source, (item, i) => selector(item));
            }
                ...
                Func<TSource, IEnumerable<TResult>> selector)
            {
                ...
                return _SelectMany(source, (item, i) => selector(item), (item, result) => result);
            }
                ...
                Func<TSource, int, IEnumerable<TResult>> selector)
            {
                ...
                return _SelectMany(source, selector, (item, result) => result);
            }
                ...
                Func<TSource, TCollection, TResult> resultSelector)
            {
                ...
                return _SelectMany(source, (item, i) => collectionSelector(item), resultSelector);
            }
                ...
                int count)
            {
                ...
                // Can't be defined in terms of Where as it'd iterate post the element count,
                // potentially causing side-effects of that iteration (or run ad infinitum).
                ...
                int count)
            {
                ...
                return _Where(source, (item, i) => i >= count);
            }
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return _TakeWhile(source, (item, i) => predicate(item));
            }
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return _SkipWhile(source, (item, i) => predicate(item));
            }
                ...
                Func<TSource, int, bool> predicate)
            {
                ...
                // Need to iterate to reset foundFirst upon re-iteration after the first one.
                // Otherwise foundFirst would remain true for subsequent iterations.
                foreach (var item in _Where(source, (item, i) => foundFirst || (foundFirst = !predicate(item, i))))
                    yield return item;
            }
            ...
            internal static IOrderedEnumerable<T> OrderByInternal<T, K>(IEnumerable<T> source, Func<T, K> keySelector, IComparer<K> comparer, bool descending)
            {
            ...
            internal static IOrderedEnumerable<T> OrderByInternal2<T, K>(IEnumerable<T> source, Func<T, K> keySelector, IComparer<K> comparer, bool descending)
            {
                ...
                IEqualityComparer<TSource> comparer)
            {
                ...
                using (IEnumerator<TSource> e2 = second.GetEnumerator())
                {
                    ...
                    while ((e1mn = e1.MoveNext()) & (e2mn = e2.MoveNext()))
                    {
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return Aggregate(source, false, (any, item) => any || predicate(item));
            }
                ...
                Func<TSource, bool> predicate)
            {
                ...
                // Can't aggregate because we should preempt iteration upon hitting false.
                foreach (TSource item in source)
                    if (!predicate(item))
                        return false;
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return Aggregate(source, 0, (count, item) => predicate(item) ? checked(count + 1) : count);
            }
            ...
            )
            {
                ...
                return LongCount(source, item => true);
            }
                ...
                Func<TSource, bool> predicate)
            {
                ...
                return Aggregate(source, 0L, (count, item) => predicate(item) ? checked(count + 1) : count);
            }
                ...
                Func<TSource, int> selector)
            {
                ...
                return Aggregate(source, 0, (sum, item) => checked(sum + selector(item)));
            }
                ...
                Func<TSource, int?> selector)
            {
                ...
                return Aggregate(source, 0, (sum, item) => checked(sum + (selector(item) ?? 0)));
            }
                ...
                Func<TSource, long> selector)
            {
                ...
                return Aggregate(source, 0L, (sum, item) => checked(sum + selector(item)));
            }
                ...
                Func<TSource, long?> selector)
            {
                ...
                return Aggregate(source, 0L, (sum, item) => checked(sum + (selector(item) ?? 0L)));
            }
                ...
                Func<TSource, double> selector)
            {
                ...
                return Aggregate(source, 0.0, (sum, item) => checked(sum + selector(item)));
            }
                ...
                Func<TSource, double?> selector)
            {
                ...
                return Aggregate(source, 0.0, (sum, item) => checked(sum + (selector(item) ?? 0.0)));
            }
                ...
                Func<TSource, decimal> selector)
            {
                ...
                return Aggregate(source, 0m, (sum, item) => checked(sum + selector(item)));
            }
                ...
                Func<TSource, decimal?> selector)
            {
                ...
                return Aggregate(source, 0m, (sum, item) => checked(sum + (selector(item) ?? 0m)));
            }
                ...
                Func<TSource, float> selector)
            {
                ...
                return Aggregate(source, 0f, (sum, item) => checked(sum + selector(item)));
            }
                ...
                Func<TSource, float?> selector)
            {
                ...
                return Aggregate(source, 0f, (sum, item) => checked(sum + (selector(item) ?? 0f)));
            }
            ...
            {
                return Average(source, item => item);
            }
            ...
            {
                return Aggregate(source, seed, func, result => result);
            }
            ...
            #region 1.17 .NET 4.0 - Zip

            /// <summary>
            /// Zips elements of sequences together in pairwise manner, using the given selector function.
            /// </summary>
            /// <typeparam name="TFirst">Type of the elements in the first input Enumerable.</typeparam>
            /// <typeparam name="TSecond">Type of the elements in the second input Enumerable.</typeparam>
            /// <typeparam name="TResult">Type of the elements in the result Enumerable.</typeparam>
            /// <param name="first">First sequence of input elements.</param>
            /// <param name="second">Second sequence of input elements.</param>
            /// <param name="selector">Selector function combining elements from both input sequences.</param>
        ...
        internal class OrderedSequence<TElement> : System.Collections.Generic.IEnumerable<TElement>, BdsSoft.Linq.IOrderedEnumerable<TElement>
        {
            /// <summary>
            ...
            /// </example>
            private IList<IOrderedEnumerable<TElement>> _children;
            ...
            /// </param>
            internal OrderedSequence(IList<IOrderedEnumerable<TElement>> children)
            {
                _children = children;
                _leaf = false;
            }
            ...
            /// </summary>
            internal IList<IOrderedEnumerable<TElement>> Children
            {
            ...
            /// </example>
            internal void Patch(IList<IOrderedEnumerable<TElement>> children)
            {
                _children = children;
                _leaf = false;
            }
            ...
            internal OrderedSequence<TElement> Clone()
            {
                ...
                {
                    List<IOrderedEnumerable<TElement>> lst = new List<IOrderedEnumerable<TElement>>();
            ...
            public IOrderedEnumerable<TElement> CreateOrderedSequence<TKey>(Func<TElement, TKey> keySelector, IComparer<TKey> comparer, bool descending)
            {
                if (keySelector == null)
                    throw new ArgumentNullException();
